...
class Tx_PtConference_ViewHelpers_PaperVotingStarsViewHelper extends Tx_Fluid_Core_ViewHelper_AbstractViewHelper  {
	...
	public function renderLink($img, $paper, $rate, $link = 0) {
		...
		$uri = $uriBuilder
			...
			->uriFor('vote', array('paper' => $paper, 'rating'=>$rate), 'bestPaperVoting', 'ptconference');
