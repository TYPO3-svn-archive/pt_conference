 ...
 * @subpackage Export
 */
class Tx_PtConference_ExtList_View_BadgeExportView Extends Tx_PtExtlist_View_Export_AbstractExportView {
    ...
    public function render() {
        ...
        //$outputData = tx_pttools_div::iconvArray($outputData, 'UTF-8', 'ISO-8859-1');     // TODO: make encoding configurable via TS
