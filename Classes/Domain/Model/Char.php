 ...
 */
class Tx_PtConference_Domain_Model_Char extends Tx_Extbase_DomainObject_AbstractEntity {
	...
	/**
	 * @var Tx_Extbase_Persistence_ObjectStorage<Tx_PtConference_Domain_Model_BestCharVoting>
