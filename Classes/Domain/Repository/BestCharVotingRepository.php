 ...
 */
class Tx_PtConference_Domain_Repository_BestCharVotingRepository extends Tx_Extbase_Persistence_Repository {
	
	/**
	 * Returns a voting object for a given user and char.
	 * 
	 * @param Tx_PtConference_Domain_Model_Char $char
	 * @param integer $feUserUid
	 */
	public function findByCharAndUser($char,$feUserUid=NULL) {
