...
class Tx_PtConference_Controller_eventController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_PtConference_Domain_Repository_eventRepository
	 */
	...
	protected function initializeAction() {
		$this->eventRepository = t3lib_div::makeInstance('Tx_PtConference_Domain_Repository_eventRepository');
	}
