...
class Tx_PtConference_Controller_BadgePrintingController extends Tx_Extbase_MVC_Controller_ActionController {
	...
	public function exportAllAction() {
		...
		$badges = new Tx_PtConference_Domain_Model_Badges();
		$badges->markListedBadgesAsPrinted();
	}
}
?>