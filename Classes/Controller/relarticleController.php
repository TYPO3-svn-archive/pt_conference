...
/**
 * Controller for the relarticle object
 *
 * @version $Id$
...
class Tx_PtConference_Controller_relarticleController extends Tx_ExtbaseKickstarter_Scaffolding_AbstractScaffoldingController {
	
	/**
	 * @var Tx_PtConference_Domain_Repository_relarticleRepository
	 */
	protected $relarticleRepository;
	...
	protected function initializeAction() {
		$this->relarticleRepository = t3lib_div::makeInstance('Tx_PtConference_Domain_Repository_relarticleRepository');
	}
